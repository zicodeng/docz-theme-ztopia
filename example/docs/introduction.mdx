...
- **One theme, two looks**: Ztopia theme comes with light and dark mode. You can click
  ...
  See [Button.mdx](https://raw.githubusercontent.com/zicodeng/docz-theme-ztopia/master/example/Button.mdx) for an example
...
- **Live editing, preview, and error**: turn on the editor mode and tweak your components on the fly
